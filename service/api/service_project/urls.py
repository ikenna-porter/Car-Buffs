...
from service_rest.api_views import list_technicians, list_appointments, appointment_detail, list_services
...
urlpatterns = [
    ...
    path("api/appointment/<int:vin>/", appointment_detail, name="appointment_detail"),
